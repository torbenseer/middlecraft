...
public class HobbitItemGroups {
    ...
    public static final ItemGroup HOBBIT_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().displayName(Text.of("itemgroup.hobbit"))
                    .icon(() -> new ItemStack(HobbitItems.STONE_PROJECTILE_ITEM)).entries(((displayContext, entries) -> {
                        entries.add(HobbitItems.STONE_PROJECTILE_ITEM);
                    })).build());
     */

    public static void registerItemGroup() {
        Middlecraft.LOGGER.info("Registering Hobbit ItemGroups");
    }
}
